...
/**
 * "Quais disciplinas você está estudando?" — Discipline selection screen
 * Design language: Cognitive Sanctuary
 * Implementado com NativeWind usando cores em hex direto nas classes
 * (arbitrary values), sem depender de tokens customizados no
 * tailwind.config.js.
 */
    ...
    <SafeAreaView className="flex-1 bg-[#000000]" edges={['top', 'bottom']}>
      ...
      <View className="flex-1 px-6">
        ...
        >
          ...
          {/* Add discipline */}
          {isAdding ? (
            <View className="flex-row items-center px-4 rounded-xl border border-dashed border-[#8a2be2]/50 mb-5">
              <TextInput
                value={newDiscipline}
